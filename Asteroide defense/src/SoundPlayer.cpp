...
SoundPlayer::SoundPlayer()
    ...
    , m_sounds()
{
    m_soundBuffers.load(SoundEffect::AlliedGunfire,	"media/Sound/AlliedGunfire.wav");
    m_soundBuffers.load(SoundEffect::EnemyGunfire,	"media/Sound/EnemyGunfire.wav");
    m_soundBuffers.load(SoundEffect::Explosion1,		"media/Sound/Explosion1.wav");
    m_soundBuffers.load(SoundEffect::Explosion2,		"media/Sound/Explosion2.wav");
