...
Application::Application()
    ...
    , m_keyBinding1(1)
    , m_keyBinding2(2)
    , m_stateStack(State::Context(m_window, m_textures, m_fonts, m_music, m_sounds, m_keyBinding1, m_keyBinding2))
...
void Application::registerStates()
{
    ...
    m_stateStack.registerState<MultiplayerGameState>(States::HostGame, true);
    m_stateStack.registerState<MultiplayerGameState>(States::JoinGame, false);
    ...
    m_stateStack.registerState<GameOverState>(States::GameOver, "Mission Failed!");
    m_stateStack.registerState<GameOverState>(States::MissionSuccess, "Mission Successful!");
}
