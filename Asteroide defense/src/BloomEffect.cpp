...
{
    m_shaders.load(Shaders::BrightnessPass,   "media/Shaders/Fullpass.vert", "media/Shaders/Brightness.frag");
    m_shaders.load(Shaders::DownSamplePass,   "media/Shaders/Fullpass.vert", "media/Shaders/DownSample.frag");
    m_shaders.load(Shaders::GaussianBlurPass, "media/Shaders/Fullpass.vert", "media/Shaders/GuassianBlur.frag");
    m_shaders.load(Shaders::AddPass,          "media/Shaders/Fullpass.vert", "media/Shaders/Add.frag");
}
